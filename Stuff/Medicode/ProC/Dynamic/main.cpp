...
static unsigned long sqlctx = 32763;
...
{10,4130,0,0,0,
5,0,0,1,0,0,27,28,0,0,4,4,0,1,0,1,5,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,0,0,17,32,0,0,1,1,0,1,0,1,5,0,0,
55,0,0,2,0,0,45,40,0,0,1,1,0,1,0,1,3,0,0,
74,0,0,2,0,0,13,44,0,0,3,0,0,1,0,2,3,0,0,2,5,0,0,2,5,0,0,
101,0,0,2,0,0,15,49,0,0,0,0,0,1,0,
116,0,0,3,0,0,30,52,0,0,0,0,0,1,0,
131,0,0,4,0,0,32,61,0,0,0,0,0,1,0,
};
...

{
 ...
 if (sqlca.sqlcode < 0) error("Dynamic/main.pc");
}
...

{
    ...
    sqlstm.sqlest = (unsigned char  *)&sqlca;
    sqlstm.sqlety = (unsigned short)0;
    sqlstm.sqhstv[0] = (         void  *)h_stmt;
    sqlstm.sqhstl[0] = (unsigned int  )120;
    sqlstm.sqhsts[0] = (         int  )0;
    sqlstm.sqindv[0] = (         void  *)0;
    sqlstm.sqinds[0] = (         int  )0;
    sqlstm.sqharm[0] = (unsigned int  )0;
