...
{10,4130,0,0,0,
5,0,0,1,0,0,27,29,0,0,4,4,0,1,0,1,5,0,0,1,5,0,0,1,5,0,0,1,10,0,0,
36,0,0,2,69,0,4,34,0,0,3,0,0,1,0,2,3,0,0,2,5,0,0,2,5,0,0,
63,0,0,3,0,0,30,50,0,0,0,0,0,1,0,
78,0,0,4,0,0,32,60,0,0,0,0,0,1,0,
};
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select deptno ,dname ,loc into :b0,:b1,:b2  from dept where \
deptno=10";
